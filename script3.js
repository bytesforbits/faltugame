...
function animate(){
	...
	if(!end)
	{
		...
		ctx.drawImage(winImage,CANVAS_WIDTH*0.5-64,CANVAS_HEIGHT*0.5-64,128,128);
		ctx.font='20px Lilita One';
		ctx.fillStyle="#f5fcff"
		ctx.fillText("Reload to play again ! ! :)",CANVAS_WIDTH*0.5-50,CANVAS_HEIGHT*0.5+128 );
	}
	else if(end && !win){
		ctx.drawImage(overImage,CANVAS_WIDTH*0.5-64,CANVAS_HEIGHT*0.5-64,128,128);
		ctx.font='20px Lilita One';
		ctx.fillStyle="#f5fcff"
		ctx.fillText("Reload to play again ! ! :(",CANVAS_WIDTH*0.5-100,CANVAS_HEIGHT*0.5+128 );
	}
